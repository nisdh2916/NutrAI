...
class RecommendScreen extends StatefulWidget {
  ...
  const RecommendScreen({super.key, this.userName = '사용자'});
...
const _kCategoryMeta = <String, ({IconData icon, String desc, Color color})>{
  '전체': (
    ...
    desc: '오늘 섭취량과 목표에 맞춘 AI 맞춤 추천',
    color: AppColors.brand
  ),
  '다이어트': (
    icon: Icons.monitor_weight_rounded,
    desc: '칼로리·지방을 낮춘 체중 관리 식단',
    color: Color(0xFF3182F6)
  ),
  '기호별': (
    icon: Icons.favorite_rounded,
    desc: '입맛과 선호도 기반 취향 맞춤 메뉴',
...
class _RecommendScreenState extends State<RecommendScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance
        .addPostFrameCallback((_) => _fetchRecommendations());
  }
  ...
  Future<void> _fetchRecommendations({String? category}) async {
    ...
    try {
      ...
      final colors = [
        ...
        const Color(0xFFF5E8C0),
        const Color(0xFFE0EDD8),
                      ...
                      child: AnimatedContainer(
                        ...
                        child: Text(cat,
                            style: TextStyle(
                                ...
                                color:
                                    isSel ? Colors.white : AppColors.textSub)),
                      ),
                    ),
                  ),
                );
          ...
          child: Padding(
            ...
            child: Center(
              child: TextButton.icon(
                ...
                label: const Text('새로고침 · AI가 새로운 메뉴를 추천해요',
                ...
                Positioned(
                  ...
                  child: IconButton(
                    ...
                    style: IconButton.styleFrom(
                      ...
                      foregroundColor:
                          item.isFavorite ? AppColors.red : AppColors.textMuted,
                      fixedSize: const Size(44, 44),
                    ),
                    icon: Icon(
                      item.isFavorite
              ...
              Padding(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Row(children: [
                        _NutrPill(
                            '${item.kcal.round()}kcal', AppColors.textSub),
                        const SizedBox(width: 6),
                        _NutrPill('탄 ${item.carb.round()}g', AppColors.carb),
                        const SizedBox(width: 6),
                        _NutrPill(
                            '단 ${item.protein.round()}g', AppColors.protein),
                        const Spacer(),
                        IconButton(
                          tooltip: '이 추천 줄이기',
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                            ...
                            children: [
                              _NutrStat('칼로리', '${item.kcal.round()}', 'kcal',
                                  AppColors.text),
                              Container(
                                  width: 1,
                                  height: 32,
                              ...
                              _NutrStat('탄수화물', '${item.carb.round()}', 'g',
                                  AppColors.carb),
                              Container(
                                  width: 1,
                                  height: 32,
                                  color: AppColors.brandText
                                      .withValues(alpha: 0.2)),
                              _NutrStat('단백질', '${item.protein.round()}', 'g',
                                  AppColors.protein),
                              Container(
                                  width: 1,
                                  height: 32,
                      ...
                      Center(
                        child: TextButton(
                          ...
                          child: const Text('추천이 마음에 안 드시나요?'),
                        ),
                      ),
                    ]),
              ),
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      RichText(
        ...
        TextSpan(
            text: unit,
            style: const TextStyle(fontSize: 11, color: AppColors.brandText)),
      ])),
    ]);
  }
}
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('추천이 마음에 안 드시나요?',
              style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w700,
                  color: AppColors.text)),
          const SizedBox(height: 4),
          const Text('미선택 사유 선택 (중복가능)',
