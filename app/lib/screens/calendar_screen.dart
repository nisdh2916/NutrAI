...
class _CalendarScreenState extends State<CalendarScreen>
  ...
  List<DateTime?> get _monthGrid {
    ...
    final daysInMonth =
        DateUtils.getDaysInMonth(_monthCursor.year, _monthCursor.month);
...
class _TimelineMealRow extends StatelessWidget {
  ...
  const _TimelineMealRow(
      {required this.meal, required this.isLast, required this.onTap});
        ...
        children: [
          ...
          Column(
            children: [
              ...
              if (!isLast)
                Expanded(
                    child: Container(width: 1.5, color: AppColors.lineStrong)),
            ],
          ),
          const SizedBox(width: 12),
...
class _TimelineMealCard extends StatelessWidget {
  ...
  const _TimelineMealCard(
      {required this.meal, required this.color, required this.onTap});
      ...
      child: Column(
        children: [
          const Icon(Icons.restaurant_menu_rounded,
              size: 44, color: AppColors.lineStrong),
          const SizedBox(height: 12),
    ...
    return Container(
      ...
      child:
        ...
        Icon(Icons.image_not_supported_outlined,
            size: 28, color: AppColors.lineStrong),
        SizedBox(height: 6),
        Text('등록된 사진이 없습니다',
